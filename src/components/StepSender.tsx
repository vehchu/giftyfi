...
const StepSender = ({ value, onChange, onNext, onBack }: StepSenderProps) => {
  ...
  return (
    <motion.div {...slideIn} className="relative z-10 flex min-h-screen flex-col px-6">
      <div className="flex items-center justify-between pt-8">
        ...
        <span className="font-body text-xs text-muted-foreground">4 of 4</span>
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center">
        ...
        <input
          ...
          placeholder="Your name — or leave blank to stay mysterious"
          value={value}
